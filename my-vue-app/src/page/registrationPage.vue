...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.updateDataField(
        "inputPasswordRepeat",
        this.Data.inputPasswordRepeat,
        (value) => validationPasswordRepeat(value, this.Data.inputPassword),
      );
      if (
...
<template>
  ...
  <div class="container" v-else>
    ...
    <div class="wrap">
      <span class="title-text"> Заполните Ваши данные </span>
      <div class="wrap-input">
        <layout>
          <inputName
            :value="Data.inputName"
            @input:value="
              (value) => updateDataField('inputName', value, validationName)
            "
          />
        ...
        <layout>
          <inputEmail
            ...
            @input:value="
              (value) => updateDataField('inputEmail', value, validationEmail)
            "
          />
      ...
      <div class="wrap-input">
        <layout>
          <inputPosition
            ...
            @change:value="
              (value) =>
                updateDataField('inputPosition', value, validationPosition)
            "
            :options="[
              { value: 1, name: 'Junior' },
              { value: 2, name: 'Middle' },
      ...
      <div class="wrap-input">
        <layout>
          <inputPassword
            ...
            @input:value="
              (value) =>
                updateDataField('inputPassword', value, validationPassword)
            "
          />
        ...
        <layout>
          <inputPassword
            ...
            :value="Data.inputPasswordRepeat"
            @input:value="
              (value) =>
                updateDataField('inputPasswordRepeat', value, (v) =>
                  validationPasswordRepeat(v, Data.inputPassword),
                )
            "
          />
    ...
    <div class="grid-container">
      <toggleButton
        :value="Data.isVisibilityProfile"
        @update:value="
          (value) => {
            Data.isVisibilityProfile = value;
          }
        "
      />
